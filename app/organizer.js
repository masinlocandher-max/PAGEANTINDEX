...
(() => {
  ...
  async function enhanceOrganizerApp() {
    ...
    if (account) account.innerHTML = `<div class="hero"><h1>Organization account.</h1><p>Official pageant tools with administrator review and clear public trust boundaries.</p></div><div class="audience-account-card"><span>Account type</span><h2>Pageant Organization</h2><p>Manage official pageant information without being classified as a supplier.</p></div><div class="section"><div class="section-heading"><h2>Organization tools</h2></div><div class="audience-link-list"><a href="${WEB_URL}/platform/">Organizer OS<b>›</b></a><a href="${WEB_URL}/dashboard/#organization-profile">Organization profile<b>›</b></a><a href="${WEB_URL}/dashboard/#pageant-editions">Pageant editions<b>›</b></a><a href="${WEB_URL}/dashboard/#candidate-rosters">Candidate rosters<b>›</b></a><a href="${WEB_URL}/platform/#judging">Judging & tabulation<b>›</b></a><a href="${WEB_URL}/platform/#voting">Voting<b>›</b></a><a href="${WEB_URL}/platform/#tickets">Tickets<b>›</b></a><a href="${WEB_URL}/directory/">Find suppliers<b>›</b></a></div></div><div class="travel-note">The new Organizer OS is front-end first. Voting, tabulation, ticket transactions and official publication remain preview-only until their production data and audit layers are connected.</div>`;
  }
