  ...
  try {
    ...
    for (const offer of offers || []) {
      ...
      result.push({
        ...
        inventoryLimit: offer.inventory_limit,
        unitsAvailable: available,
        saleStartsAt: offer.sale_starts_at,
        saleEndsAt: offer.sale_ends_at,
        status: offer.status,
        edition: {
          id: edition.id,
          organizationName: edition.organization_name,
          pageantName: edition.pageant_name,
          editionName: edition.edition_name,
          editionYear: edition.edition_year,
          venue: edition.venue,
          eventStartAt: edition.event_start_at,
          eventEndAt: edition.event_end_at,
          countryName: edition.country_name,
          city: edition.city,
        },
      });
    }
