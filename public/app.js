...
function pricingPage() {
  return `<main>${pageHero("Join Pageant Index. Grow when you are ready.", "Public discovery stays free. Professionals can begin with a useful free profile, then upgrade for stronger portfolio, analytics, and business tools.", "List Your Business")}
  <section class="section membership-section"><div class="container">
    <div class="public-access-band">${assetIcon("search")}<div><h2>Pageant Index is free for the public.</h2><p>Anyone can search professionals, browse portfolios, read guides, view the calendar, save profiles, share listings, and send inquiries without paying.</p></div></div>
    <div class="pricing-grid membership-grid">
      <article class="price-card">
        <div class="plan-label">Build nationwide coverage</div>
        <h2 class="plan-title">Free Profile</h2>
        <div class="plan-price"><strong>₱0</strong><span>forever</span></div>
        <p class="plan-desc">A credible starting point for every legitimate pageant professional, organization, team, or supplier.</p>
        <ul class="feature-list"><li>Business name, category, and location</li><li>Logo and cover image</li><li>Short professional introduction</li><li>Contact and official social links</li><li>Up to 6 portfolio assets</li><li>Up to 5 listed services</li><li>Basic inquiries and profile statistics</li><li>Organic discovery and ranking eligibility</li></ul>
        <a class="btn btn-ghost btn-block" href="/sign-up/">Create Free Profile</a>
      </article>
      <article class="price-card popular">
        <div class="plan-label">Professional growth</div>
        <h2 class="plan-title">Pageant Index Pro</h2>
        <div class="plan-price"><strong>₱499</strong><span>/ month</span></div>
        <div class="annual-price">or ₱4,990 yearly</div>
        <p class="plan-desc">For professionals ready to present more work and manage serious client interest.</p>
        <ul class="feature-list"><li>Everything in Free</li><li>Up to 30 HD portfolio assets</li><li>Service packages and starting-price ranges</li><li>Expanded biography and credentials</li><li>Inquiry management dashboard</li><li>Profile visitor and inquiry analytics</li><li>Nationwide and travel visibility</li><li>Priority profile review</li><li>Downloadable profile kit</li></ul>
        <button class="btn btn-primary btn-block plan-select" data-plan="Pageant Index Pro">Choose Pro</button>
      </article>
      <article class="price-card authority-plan">
        <div class="plan-label">Established businesses</div>
        <h2 class="plan-title">Pageant Index Authority</h2>
        <div class="plan-price"><strong>₱1,499</strong><span>/ month</span></div>
        <div class="annual-price">or ₱14,990 yearly</div>
        <p class="plan-desc">For established suppliers, studios, organizations, and teams requiring deeper visibility tools.</p>
        <ul class="feature-list"><li>Everything in Pro</li><li>Featured portfolio sections</li><li>Video portfolio support</li><li>Lead and inquiry reporting</li><li>Team-member profiles</li><li>Multiple service locations</li><li>Enhanced profile SEO data</li><li>Category insights</li><li>Quarterly profile optimization</li></ul>
        <button class="btn btn-primary btn-block plan-select" data-plan="Pageant Index Authority">Choose Authority</button>
      </article>
    </div>
    <div id="founding" class="cta-band founding-band"><div class="cta-inner"><div><h2>Founding 100 Program</h2><p>The first 100 qualified professionals receive a free profile permanently, six months of Pro tools, a Founding Professional distinction, and no automatic paid renewal. Qualification and review are required.</p></div><button class="btn btn-gold plan-select" data-plan="Founding 100 Program">Apply for the Founding 100</button></div></div>
    <div class="commercial-separation">
      <div><div class="plan-label">Advertising</div><h2>Campaign rates remain private.</h2><p>Homepage placements, category sponsorships, sponsored editorial, calendar placements, newsletters, supplier spotlights, and partnerships are planned separately for each campaign.</p><a class="btn btn-secondary" href="/advertise/">Request a Campaign Brief</a></div>
      <div class="trust-rules"><h2>Payment buys tools, never trust.</h2><ul class="feature-list"><li>Verification cannot be purchased</li><li>Reviews cannot be purchased or removed for payment</li><li>Paid plans do not increase organic ranking scores</li><li>Advertising is visibly labeled</li><li>Editorial praise and awards are never guaranteed</li></ul></div>
    </div>
  </div></section></main>`;
}
